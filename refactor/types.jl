...
struct MLBSlate <: Slate
    ...
    players::Vector{NamedTuple{(:Name, :ID, :Position, :Salary, :Game, :Team, :Opponent, :Order, :Opp_Pitcher, :Projection, :Proj_Ownership),Tuple{String,String,String,Int64,String,String,String,Int64,Union{Missing,String},Float64,Float64}}}
